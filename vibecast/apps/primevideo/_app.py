...
from vibecast.apps.primevideo._api import PrimeVideoAPI
...
class PrimeVideo(StatefulAppProvider[_PrimeSessionState]):
    """Amazon Prime Video app implementation."""
