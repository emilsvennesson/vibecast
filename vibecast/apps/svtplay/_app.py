...
from vibecast.apps.svtplay._api import SvtPlayAPI
...
class _SessionState:
    """Mutable app state for one app session."""

    api: SvtPlayAPI


class SvtPlay(StatefulAppProvider[_SessionState]):
    """SVT Play app implementation."""
