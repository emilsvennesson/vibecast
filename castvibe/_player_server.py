"""aiohttp bridge exposing the universal player protocol over WS/HTTP."""
...
class PlayerServer(Player):
    """HTTP/WebSocket server bridging external players to coordinators."""
    ...
    async def stop(self) -> None:
        ...
        log.info("player server stopped")
    ...
    async def _handle_ws(self, request: web.Request) -> web.WebSocketResponse:
        ...
        connection = _PlayerConnection(ws=ws, requested_role=role)
    ...
    def _assign_primary(self, connection: _PlayerConnection) -> None:
    ...
    def _remove_connection(self, connection: _PlayerConnection) -> None:
    ...
    async def _sync_connection(self, connection: _PlayerConnection) -> None:
